...
- Name: happy-path/training-permissions.spec.ts >> Training Permissions + Notifications (AC-67 to AC-80) >> login as admin (Manuel) with full permissions
- Location: e2e/specs/happy-path/training-permissions.spec.ts:22:3
