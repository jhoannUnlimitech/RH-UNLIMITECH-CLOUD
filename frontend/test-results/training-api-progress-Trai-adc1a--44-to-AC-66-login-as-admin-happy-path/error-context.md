...
- Name: happy-path/training-api-progress.spec.ts >> Training API — Progress + Exams (AC-44 to AC-66) >> login as admin
- Location: e2e/specs/happy-path/training-api-progress.spec.ts:51:3
