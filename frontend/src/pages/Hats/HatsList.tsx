...
const HatsList = observer(() => {
  ...
  return (
    <div className="flex flex-col gap-6" data-test-context="hats-list">
      {/* Breadcrumb */}
      ...
      <div className="flex items-center justify-between">
        ...
        {can('roles', 'create') && (
          <Button onClick={() => navigate('/roles/new')} className="flex items-center gap-2" data-test-key="create-hat-button">
