...
const EmployeesList = observer(() => {
  ...
  return (
    <div className="flex flex-col gap-6" data-test-context="employees-list" data-test-state={employeesStore.isLoading ? "loading" : "loaded"}>
      {/* Breadcrumb */}
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Gestiona el directorio de empleados de la organización
          </p>
        </div>
        {can('employees', 'create') && (
          <Button
            ...
            data-test-key="create-employee-button"
          >
            <svg
              width="20"
              height="20"
                    ...
                    <TableCell className="py-3.5 px-4 sm:px-6">
                      <div className="flex items-center justify-center gap-3">
                        ...
                        <button
                          ...
                          data-test-key="suspend-button"
                          data-test-state={employee.status}
                        >
                          {employee.status === 'active' ? (
                            <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
