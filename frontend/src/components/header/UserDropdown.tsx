    ...
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 bg-brand-100 dark:bg-brand-900 flex items-center justify-center">
          {authStore.user?.photo ? (
            <img src={authStore.user.photo} alt="User" />
          ) : (
      ...
      >
        <div>
          ...
          <span className="mt-1 inline-block px-2 py-0.5 text-xs rounded-full bg-brand-50 text-brand-700 dark:bg-brand-900/30 dark:text-brand-400">
            {userRole}
          </span>
        </div>
