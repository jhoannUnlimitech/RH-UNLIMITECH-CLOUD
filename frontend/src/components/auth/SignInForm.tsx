...
const SignInForm = observer(() => {
  ...
  return (
    <div className="flex flex-col flex-1" data-test-context="signin-page">
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div>
          ...
          <form
            ...
            data-test-context="login-form"
            data-test-state={authStore.isLoading ? "loading" : "ready"}
          >
            {authStore.error && (
              <div
            ...
            <div className="space-y-6" data-test-context="login-inputs">
              <div>
                <Label>
                ...
                <Input
                  ...
                  required
                  id="email-input"
                  data-test-key="email-input"
                  data-test-state={authStore.error ? "error" : "normal"}
                />
              </div>
              <div>
                <Label>
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    id="password-input"
                    data-test-key="password-input"
                    data-test-state={authStore.error ? "error" : "normal"}
                  />
                  <span
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute z-30 -translate-y-1/2 cursor-pointer right-4 top-1/2"
                    data-test-key="show-password-toggle"
                  >
                    {showPassword ? (
