 ...
 * 
 * Uso: npx playwright test scripts/capture-screenshots.ts
 * O:   npx ts-node scripts/capture-screenshots.ts
 */
...
async function main() {
  ...
  // CSW Detail - capturar una solicitud específica si existe
  ...
  await page.screenshot({ 
    path: path.join(OUTPUT_DIR, '16-csw-detalle.png'), 
    fullPage: true 
  });
